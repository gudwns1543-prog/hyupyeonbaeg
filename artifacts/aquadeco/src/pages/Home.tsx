...
export default function Home() {
  ...
  const gc = (key: string, fallback: string) => {
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-20 bg-stone-50">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <InlineEditText
              contentKey="products_section_title"
              value={gc("products_section_title", "히노끼 욕조 제품")}
              as="h2"
              className="text-3xl md:text-4xl font-bold mb-4 text-foreground"
            />
            <InlineEditText
              contentKey="products_section_desc"
              value={gc("products_section_desc", "100% 일본산 히노끼(편백)나무를 사용한 수공예 욕조. 내구성과 아름다움을 겸비한 명품 욕조를 직접 제작합니다.")}
              as="p"
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group border border-stone-100">
              ...
              <div className="p-8">
                <InlineEditText
                  contentKey="product_half_title"
                  value={gc("product_half_title", "히노끼 반신욕조")}
                  as="h3"
                  className="text-2xl font-bold text-foreground mb-2"
                />
                <InlineEditText
                  contentKey="product_half_desc"
                  value={gc("product_half_desc", "욕실 공간을 효율적으로 활용하는 반신욕 전용 욕조. 편백나무의 피톤치드 효과로 혈액순환과 피로회복에 탁월합니다.")}
                  as="p"
                ...
                <div className="flex items-center justify-between">
                  <InlineEditText
                    contentKey="product_half_price"
                    value={gc("product_half_price", "1,320,000원~")}
                    as="span"
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group border border-stone-100">
              ...
              <div className="p-8">
                <InlineEditText
                  contentKey="product_full_title"
                  value={gc("product_full_title", "히노끼 전신욕조")}
                  as="h3"
                  className="text-2xl font-bold text-foreground mb-2"
                />
                <InlineEditText
                  contentKey="product_full_desc"
                  value={gc("product_full_desc", "전신을 편안하게 담글 수 있는 전신욕 전용 욕조. 자연 방부 효과로 오랫동안 위생적으로 사용 가능합니다.")}
                  as="p"
                  className="text-muted-foreground mb-4 leading-relaxed text-sm"
                  multiline
                />
                <div className="flex items-center justify-between">
                  <InlineEditText
                    contentKey="product_full_price"
                    value={gc("product_full_price", "1,650,000원~")}
                    as="span"
                    className="text-2xl font-bold text-primary"
                  />
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            <div className="order-1 md:order-2">
              ...
              <InlineEditText
                ...
                value={gc("about_title", "히노끼욕조 전문 기업,\n휴편백입니다")}
                as="h2"
                className="text-3xl md:text-4xl font-bold mb-6 text-foreground leading-snug whitespace-pre-line"
                multiline
              />
              <InlineEditText
                contentKey="about_desc"
                value={gc("about_desc", "휴편백은 100% 일본산 히노끼(편백)나무를 직수입하여 국내 최고의 장인 기술로 욕조를 제작하는 전문 기업입니다. 나무의 자연 방향 성분인 피톤치드가 몸과 마음을 치유합니다.")}
                as="p"
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <InlineEditText
              ...
              value={gc("why_title", "히노끼욕조를 선택하는 이유")}
              as="h2"
              className="text-3xl md:text-4xl font-bold mb-4 text-foreground"
            />
          </div>
              ...
              return (
                <div key={i} className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow border border-stone-100">
                  ...
                  <InlineEditText
                    ...
                    value={gc(item.titleKey, item.defaultTitle)}
                    as="h4"
                    className="font-bold text-foreground mb-2 text-sm"
                  />
                  <InlineEditText
                    contentKey={item.descKey}
                    value={gc(item.descKey, item.defaultDesc)}
                    as="p"
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <InlineEditText
              ...
              value={gc("process_title", "시공 진행 과정")}
              as="h2"
              className="text-3xl md:text-4xl font-bold mb-4"
            />
            <InlineEditText
              contentKey="process_subtitle"
              value={gc("process_subtitle", "체계적이고 투명한 프로세스로 최고의 결과를 완성합니다.")}
              as="p"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {([
              ...
              <div key={i} className="text-center relative">
                ...
                <InlineEditText
                  contentKey={process.titleKey}
                  value={gc(process.titleKey, process.defaultTitle)}
                  as="h4"
                  className="text-base font-semibold mb-1"
                />
                <InlineEditText
                  contentKey={process.descKey}
                  value={gc(process.descKey, process.defaultDesc)}
                  as="p"
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          ...
          <InlineEditText
            contentKey="contact_cta_title"
            value={gc("contact_cta_title", "궁금하신 점이 있으신가요?")}
            as="h2"
            className="text-3xl md:text-4xl font-bold mb-4 text-foreground"
          />
          <InlineEditText
            contentKey="contact_cta_desc"
            value={gc("contact_cta_desc", "히노끼욕조에 대한 어떤 질문이든 편하게 연락 주세요.\n전문 상담사가 친절하게 안내해 드립니다.")}
            as="p"
            className="text-muted-foreground text-base mb-10 leading-relaxed whitespace-pre-line"
            multiline
          />
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
